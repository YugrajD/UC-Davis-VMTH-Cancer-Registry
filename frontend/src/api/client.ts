...
export interface BreedDetail {
  ...
  county_cases: { county_name: string; fips_code: string; count: number; county_all_tested: number; county_breed_tested: number }[];
}
...
export interface AgeDetail {
  ...
  county_cases: { county_name: string; fips_code: string; count: number; county_all_tested: number; county_age_tested: number }[];
}
