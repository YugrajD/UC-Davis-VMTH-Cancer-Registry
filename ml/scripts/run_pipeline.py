...
Usage:
  ...
  python ml/scripts/run_pipeline.py --group-classifier ml/model/checkpoints/group_classifier_best.pt
...
from petbert_pipeline.cli import build_config, build_parser
